...
\ustcsetup{
  title              = {基于 XDP 的 UDP 包伪装方案},
  title*             = {UDP packet obfuscation based on XDP},
  author             = {明宇龙},
  author*            = {Yulong Ming},
  speciality         = {计算机科学与技术},
  speciality*        = {Computer Science and Technology},
  supervisor         = {华蓓教授},
  supervisor*        = {Prof. Bei Hua},
  % date               = {2017-05-01},  % 默认为今日
  % professional-type  = {专业学位类型},
  % professional-type* = {Professional degree type},
  department         = {计算机科学与技术系},  % 院系，本科生需要填写
  student-id         = {PB18111710},  % 学号，本科生需要填写
